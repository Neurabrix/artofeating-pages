...
(() => {
  ...
  dialog.innerHTML = `<div class="viewer-shell">
    <div class="viewer-toolbar"><span class="viewer-brand">Art of Eating <span>/ Gallery & articles</span></span><button type="button" data-viewer-close autofocus aria-label="Close viewer">Close <span aria-hidden="true">×</span></button></div>
